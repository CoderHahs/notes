...
Continuous data are data which come from a continuous interval of possible outcomes. It means that continuous data have _infinitely many outcomes_.

The _cumulative distribution function_ remains the same for discrete and continuous random data.
