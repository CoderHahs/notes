...
## Fore each of the following five services offered by the operating system, explain how each providesconvenience to the users.  Explain also in which cases it would be impossible for user-level programs to provide these services.
